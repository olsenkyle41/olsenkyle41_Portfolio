...
## Conclusion
```{r}
# Principle Component Analysis is meant to give better understnd of the "components" of a dataset.  We can also use Principle Component Analysis to reduce the dimensionality of the data.  
```
